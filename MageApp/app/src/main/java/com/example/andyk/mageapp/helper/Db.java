package com.example.andyk.mageapp.helper;
...
import com.example.andyk.mageapp.db.LogDbHelper;

import java.util.ArrayList;
import java.util.List;

import static com.example.andyk.mageapp.db.LogDbContract.LogEntry;
