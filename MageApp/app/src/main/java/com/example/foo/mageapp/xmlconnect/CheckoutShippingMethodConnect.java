...
public class CheckoutShippingMethodConnect extends DefaultConnect {
    ...
    public List<ShippingMethod> fetchShippingMethods() {
        String url = this.getRequestUrl();
        String resp = this.getContentByUrl(url);
//        String resp = this.getShippingMethodsResponse();
        List<ShippingMethod> methods = this.getShippingMethods(resp);
        return methods;
    }
    ...
    protected List<ShippingMethod> getShippingMethods(String xml) {
